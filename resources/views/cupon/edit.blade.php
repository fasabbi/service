...
<input type="text" class="form-control" name="cupon_name" 
 placeholder="Enter cupon" value="{{$cupon->cupon_name}}">
</div>
<div class="form-group">
    <label>discount amount</label>
<input type="text" class="form-control" name="discount_amount"
 placeholder="discount(%)" value="{{$cupon->discount_amount}}">
</div>
<div class="form-group">
    <label>expire date</label>
<input type="date" class="form-control" name="expire_date" 
 placeholder="expire date" value="{{$cupon->expire_date}}">
</div>
<div class="form-group">
    <label>usage limit</label>
<input type="text" class="form-control" name="usage_limit" 
 placeholder="usage limit" value="{{$cupon->usage_limit}}">
</div>
{{-- @error('category_name')
<span class="text-danger">{{$message}}</span>
@enderror --}}
<button type="submit" class="btn btn-primary">edit cupon</button>
<br>
<br>
  @if (session('status'))
