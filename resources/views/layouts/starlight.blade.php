...
<html lang="en">
  ...
  <body>
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{url('/')}}"><i class="icon ion-android-star-outline"></i> Go Home</a></div>
      ...
      <div class="sl-sideleft-menu">
        <a href="{{url('home')}}" class="sl-menu-link @yield('dashboard')">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">(private)Dashboard</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        {{-- @if (Auth::user()->role == 1) --}}
          ...
          <a href="{{url('orders')}}" class="sl-menu-link @yield('orders')">
            <div class="sl-menu-item">
              <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
