...
<span class="pull-left">${{$product_info->product_price}}</span>
                        ...
                        <p><span class="btn btn-primary btn-lg btn-block"> Scroll down for full details</span></p>
                        ...
                        <ul  class="socil-icon">
                            ...
                            <li 
                             style="width: 450px;overflow-x: scroll;"
                             >Short Details::{{$product_info->product_short}} </li>
            ...
            <div class="row mt-60">
                <div class="col-12">
                    <div class="single-product-menu">
                        <ul class="nav">
                            <li><a class="active" data-toggle="tab" href="#description">Full Details</a> </li>
...
<ul>
<li><a href="{{url('product/details')}}/{{$ppp->id}}"><i class="fa fa-shopping-cart"></i></a></li>
